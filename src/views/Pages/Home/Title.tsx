	...
	return (
		...
		>
			...
			<Canvas padding={{ top: 24, left: 24 }}>
				...
				<Label index={2} text="by Exceptional" position={px(0, 63)} transparency={0.15} />
				<Label index={3} text="Fanta Edition" position={px(0, 86)} transparency={0.3} />
				<Label index={4} text="(literally js better flight)" position={new UDim2(0, 0, 1, -40)} transparency={0.45} />
			</Canvas>
		</Card>
	);
}
